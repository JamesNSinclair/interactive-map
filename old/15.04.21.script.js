...
for (var i = 0; i < boroughsAvailable.length; i++) {
  ...
  var boroughClass = boroughsAvailable[i].img.className
console.log(boroughClass)
  if (boroughsAvailable[i].offsetHeight > 100) {
     var boroughStyles = document.createElement('div')
      boroughStyles.innerHTML = '<style> .' + boroughClass + `:hover {
  background-color: yellow;
// transform: translate(50%, 50%) scale(1.5);
z-index: 550;} .` + boroughClass  + `:parent:after {
